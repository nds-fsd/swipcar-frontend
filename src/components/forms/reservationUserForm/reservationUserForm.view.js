...
const ReservationUserForm = ({ toEdit, handleModal, updateSuccess, systemMessage }) => {
  ...
  return (
    ...
    `}
          >
            <div className={styles._boxElements}>
              <label className={styles._label_show_info}>Empresa</label>
              <h3 className={styles._show_info}>{provider?.companyname}</h3>
            </div>
            <div className={styles._boxElements}>
              <label className={styles._label_show_info}>Email de la empresa</label>
              <h3 className={styles._show_info}>
                {provider?.email}{' '}
                <a
                  href={`mailto:${provider?.email}?subject=Solicitud de información de reserva&body=Quisiera recibir información respecto a la reserva efectuada`}
                  title="Contactar con la empresa"
    ...
    `}
          >
            <div className={styles._boxElements}>
              <label className={styles._label_show_info}>Teléfono de la empresa</label>
              <h3 className={styles._show_info}>{provider?.phone}</h3>
            </div>
            <div className={styles._boxElements}>
              <label className={styles._label_show_info}>Web de la empresa</label>
              <h3 className={styles._show_info}>
                {provider?.web}{' '}
                <a
                  href={`${provider?.web}`}
                  target="blank"
                  title="Visita la web de la empresa"
                  className={styles._icon_form_button}
                >
                  <Web />
                </a>
