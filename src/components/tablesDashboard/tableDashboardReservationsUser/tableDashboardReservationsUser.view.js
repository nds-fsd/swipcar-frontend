...
const TableDashboardReservationsUser = ({ handleModal, update }) => {
  ...
  const Row = ({ _id, rentingoffer, position }) => {
    let company = rentingoffer?.provider?.companyname;
    ...
    return (
      <div className={`${styles._table_body_info} ${position % 2 !== 0 && styles._table_row_back}`}>
        ...
        <div className={`${styles._table_tr_info}`}>{time} meses</div>
          ...
          <div className={styles._table_search}>
            ...
            <div className={styles.table}>
              <div className={styles.header}>
                <div onClick={() => sortBy('name')}>Compañia</div>
                ...
                <div onClick={() => sortBy('km')}>Km anuales</div>
                <div onClick={() => sortBy('time')}>Tiempo</div>
