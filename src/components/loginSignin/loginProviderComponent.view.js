  ...
  return (
    <>
      {(windowSize === 'xlg' || windowSize === 'lg' || windowSize === 'md') && (
        <>
          ...
          <div className={`${styles._right_login_container} ${styles[move]}`}>
            <div className={styles._right_login_title_container}>¡Estimado Proveedor!</div>
      ...
      {windowSize === 'sm' && (
        <>
          <form onSubmit={handleSubmit(onSubmitLogin)}>
            <div className={styles._login_wrapper_sm}>
              <div className={styles._top_container_sm}>
                <div className={styles._login_title_container_sm}>¡Bienvenido de nuevo!</div>
                <div className={styles._input_container}>
                  <LoginSigninInput
                    label="Introduce tu email"
                    placeholder="email"
            ...
            <div className={styles._bottom_container_sm}>
              <div className={styles._bottom_button_container_sm}>
                <GreenButton design="filled" label="Registrarse" onClick={() => handleForm()} />
              </div>
            </div>
          </form>
